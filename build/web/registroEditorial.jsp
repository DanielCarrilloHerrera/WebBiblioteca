<%-- 
    Document   : registroCategooria
    Created on : 13/04/2018, 11:12:16 AM
    Author     : dacarrillo
--%>
										...
										<div>
                                                                                    <form action="editorialControl" method="post" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="tel" name="telefono" value="" placeholder="Telefono de la editorial"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="direccion" value="" placeholder="Dirección de la editorial"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="email" name="email" value="" placeholder="Email de la editorial"/>
                                                                                            </div>
                                                                                        </div>
